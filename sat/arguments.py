...
def add_training_args(parser):
    ...
    group.add_argument('--resume-save', type=str, default=None,
                       help='Path to resume training from. Will override --save if set. Will also override --load if there is a checkpoint in the path.')
