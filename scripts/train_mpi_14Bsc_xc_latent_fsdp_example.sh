...
MASTER_PORT="${MASTER_PORT:-${MLP_WORKER_0_PORT:-35446}}"
JOB_NAME="${JOB_NAME:-scail2-fsdp-example}"
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/mpi_logs}"
MPI_HOSTFILE="${MPI_HOSTFILE:-/root/mpi_hostfile}"
CONFIG="${CONFIG:-configs/training/wan_pose_14Bsc_xc_latent_fsdp_example.yaml}"
